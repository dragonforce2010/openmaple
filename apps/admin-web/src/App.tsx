...
export function App() {
  ...
  const entityNav = useMemo<EntityNavValue>(() => ({
    ...
    openCredentialForVault: (vaultId: string) => { setModalVaultId(vaultId); setModalVaultName(vaults.find((v) => v.id === vaultId)?.display_name ?? ""); setModal("credential"); },
