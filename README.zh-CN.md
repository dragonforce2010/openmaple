...
[2 分钟 OpenMaple 平台总览](https://dragonforce2010.github.io/openmaple/#tour) 可以在项目官网直接播放，也可以在 [YouTube](https://www.youtube.com/watch?v=zYhgkFomZ7M) 观看，素材来自真实运行的控制台和端到端截图。[Local Docker walkthrough](https://dragonforce2010.github.io/openmaple/#local-docker-tour) 专门展示一条命令启动、浏览器 onboarding、runtime/sandbox pool 和 session UI。
...
下面截图来自同一套正在运行的 local Docker 栈：setup 脚本、浏览器 onboarding、workspace settings、本地 runtime/sandbox pool，以及带事件流的 seeded session。

| Onboarding workspace | Runtime provider |
|---|---|
| <img src="assets/screenshots/openmaple-local-onboarding-workspace.png" alt="OpenMaple local Docker onboarding workspace 表单截图"> | <img src="assets/screenshots/openmaple-local-onboarding-runtime.png" alt="OpenMaple local Docker onboarding runtime provider 截图"> |
| Sandbox provider | Empty model pool |
| <img src="assets/screenshots/openmaple-local-onboarding-sandbox.png" alt="OpenMaple local Docker onboarding sandbox provider 截图"> | <img src="assets/screenshots/openmaple-local-onboarding-models.png" alt="OpenMaple local Docker onboarding model pool 截图"> |
| Runtime pool members | Sandbox pool members |
| <img src="assets/screenshots/openmaple-local-runtime-pool-drawer.png" alt="OpenMaple local Docker runtime pool member drawer 截图"> | <img src="assets/screenshots/openmaple-local-sandbox-pool-drawer.png" alt="OpenMaple local Docker sandbox pool member drawer 截图"> |
| Session timeline | Model settings |
| <img src="assets/screenshots/openmaple-local-session-dashboard.png" alt="OpenMaple local Docker session transcript 和 event timeline 截图"> | <img src="assets/screenshots/openmaple-local-settings-models.png" alt="OpenMaple local Docker model settings 截图"> |
