...
_截图来自正在运行的 OpenMaple 控制台。Local Docker 证据截图只使用 demo / 本地测试身份，不暴露 secret key。_
...
[2 分钟 OpenMaple 平台总览](https://dragonforce2010.github.io/openmaple/#tour) 可以在项目官网直接播放，也可以在 [YouTube](https://www.youtube.com/watch?v=zYhgkFomZ7M) 观看，素材来自真实运行的控制台和端到端截图。[Local Docker walkthrough](https://dragonforce2010.github.io/openmaple/#local-docker-tour) 专门展示一条命令启动、workspace settings、runtime/sandbox pool、sessions 和 quickstart UI。
...
| Local Docker 路径能从命令走到 UI 证据 | 看 [local Docker walkthrough](https://dragonforce2010.github.io/openmaple/#local-docker-tour)，再看下面的截图链路。 |
...
<img src="assets/screenshots/openmaple-local-setup-terminal.png" alt="OpenMaple local Docker setup 终端输出截图，展示一条命令、健康检查和本地登录 URL">
...
下面高清截图来自同一套正在运行的 local Docker 栈：setup 脚本、dashboard、workspace settings、本地 runtime/sandbox pool、sessions 和 quickstart。每张图都从真实产品 UI 以 `5120x2880` 采集。

| Setup + smoke | Demo workspace |
|---|---|
| <img src="assets/screenshots/openmaple-local-setup-terminal.png" alt="OpenMaple local Docker setup 终端输出截图，展示一条命令、smoke 检查和本地登录 URL"> | <img src="assets/screenshots/openmaple-local-dashboard.png" alt="OpenMaple local Docker demo workspace dashboard 截图"> |
| Settings overview | Runtime provider |
| <img src="assets/screenshots/openmaple-local-settings-overview.png" alt="OpenMaple local Docker workspace settings overview 截图"> | <img src="assets/screenshots/openmaple-local-settings-runtime.png" alt="OpenMaple local Docker runtime provider settings 截图"> |
| Runtime pool members | Sandbox provider |
| <img src="assets/screenshots/openmaple-local-runtime-pool-drawer.png" alt="OpenMaple local Docker runtime pool member drawer 截图"> | <img src="assets/screenshots/openmaple-local-settings-sandbox.png" alt="OpenMaple local Docker sandbox provider settings 截图"> |
| Sandbox pool members | Sessions list |
| <img src="assets/screenshots/openmaple-local-sandbox-pool-drawer.png" alt="OpenMaple local Docker sandbox pool member drawer 截图"> | <img src="assets/screenshots/openmaple-local-sessions-list.png" alt="OpenMaple local Docker sessions list 截图"> |
| Session timeline | Quickstart |
| <img src="assets/screenshots/openmaple-local-session-dashboard.png" alt="OpenMaple local Docker session transcript 和 event timeline 截图"> | <img src="assets/screenshots/openmaple-local-quickstart.png" alt="OpenMaple local Docker quickstart builder 截图"> |
